...
export default {
    methods: {
        ...
        handleSubmit() {
            const keyword = this.$refs.inputField.value;
...
<template>
    <div
        class="fixed z-30 bg-white dark:text-gray-100 dark:bg-dark-600 top-0 right-0 w-full h-10 py-6 flex items-center justify-between border-b dark:border-dark-100">
                    ...
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"
                        ...
                        <g class="stroke-current fill-current style-scope yt-icon">
                            <path d="M21,6H3V5h18V6z M21,11H3v1h18V11z M21,17H3v1h18V17z"
                                class="stroke-current fill-current style-scope yt-icon"></path>
                        </g>
                    </svg>
                </div>
            </button>
                    ...
                    <router-link :to="{ name: 'home' }">
                        <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false"
                            ...
                            <g viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" class=" style-scope yt-icon">
                                ...
                                <g class=" fill-current style-scope yt-icon">
                                    <g id="youtube-paths" class="stroke-current fill-current style-scope yt-icon">
                                        <path
        ...
        <form @submit="$event => { $event.preventDefault(); handleSubmit() }">
            <div class="middle flex items-center">
                ...
                <div class="search border dark:border-dark-100  h-full flex items-center">
                    ...
                    <input class=" outline-none bg-transparent dark:text-gray-200" type="text" ref="inputField"
                        placeholder="Search ">
                ...
                <button class="hover:bg-gray-200 bg-gray-50 dark:bg-dark-900 dark:hover:bg-dark-600 rounded-full ml-2">
                    <div class="w-10 p-2 ">
                        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"
                            class="stroke-current fill-current style-scope yt-icon"
                            style="pointer-events: none; display: block; width: 100%; height: 100%;">
        ...
        <div class="right flex items-center pr-10">
            <button class="mx-2 relative group text-center">
                ...
                <p
                    class="text-sm px-2 right-0 tip absolute bg-gray-700 bg-opacity-70 rounded-md text-white -bottom-5   self-center hidden group-hover:block ">
                    Create
                </p>
            </button>
            <button class="mx-2">
